...
class TestsTestDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->parameters = array(
            ...
            'database_host' => NULL,
            'database_port' => NULL,
            'database_name' => (dirname(dirname(__DIR__)).'/Tests/db/test.db'),
            'database_path' => (dirname(dirname(__DIR__)).'/Tests/db/test.db'),
            'database_user' => NULL,
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_sqlite', 'user' => 'test', 'path' => (dirname(dirname(__DIR__)).'/sqlite.db.cache'), 'charset' => 'UTF8', 'host' => 'localhost', 'port' => NULL, 'password' => NULL, 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array((dirname(dirname(__DIR__)).'/config/doctrine') => 'Diside\\SecurityBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'Diside\\SecurityBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('DisideSecurityBundle' => 'Diside\\SecurityBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_79a85cafcb30f43eb9b02d245049e0de3837ed6f821a948ffee08c6c5cf220f9');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $l->setOptions(array('login_path' => 'login', 'use_referer' => true, 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path'));
        $l->setProviderKey('main');

        $m = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $i, array(), NULL);
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => array(0 => 'form_div_layout.html.twig'), 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'debug' => true, 'paths' => array()));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/Resources/views'), 'DisideSecurity');
